...
var Schema = function () {
  ...
  _createClass(Schema, [{
    ...
    value: function reloadData() {
      ...
      this.data = {};
      this.perms = {};
      return this._collection.find({}).then(function (results) {
    ...
    value: function addClassIfNotExists(className, fields) {
      ...
      return this._collection.insertOne(mongoObject.result).then(function (result) {
        return result.ops[0];
    ...
    value: function validateClassName(className, freeze) {
      ...
      return this._collection.insertOne({ _id: className }).then(function () {
    ...
    value: function setPermissions(className, perms) {
      ...
      update = { '$set': update };
      return this._collection.updateOne(query, update).then(function () {
    ...
    value: function validateField(className, key, type, freeze) {
      ...
      update[key] = type;
      update = { '$set': update };
      return this._collection.upsertOne(query, update).then(function () {
        // The update succeeded. Reload the schema
    ...
    value: function deleteField(fieldName, className, database) {
      ...
      return this.reloadData().then(function () {
        ...
        .then(function () {
          return _this5._collection.updateOne({ _id: className }, { $unset: _defineProperty({}, fieldName, null) });
        });
      });
    }
